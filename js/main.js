$(document).ready(function () {
  ...
  $("#contenedor").html(
    "<h1 id='tituloPrincipal'>Galería de Arte</h1>" +
    "<div id='galeria'></div>"
  );
  ...
  $(".obra img").on("mouseenter", function () {
    ...
    $("#preview").html(
      "<img src='" + srcImagen + "' style='max-width:70vw; max-height:80vh;'>"
    );
  ...
  $("body").append(
    "<footer id='footer'>" +
    "<div id='lineaDorada'></div>" +
    "<div id='firma'>Realizado por Osvaldo Ramírez © " +
    new Date().getFullYear() +
    "</div>" +
    "<button id='btnTop'>Volver arriba</button>" +
    "</footer>"
  );
